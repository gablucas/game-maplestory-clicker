...
const wp1 = new weaponsFactory('Wooden Sword', 1, 2, 100, 'sword_01', 'img/itens/weapons/woodensword.png');
const wp2 = new weaponsFactory('Two-Handed Sword', 1, 3, 100, 'sword_02', 'img/itens/weapons/twohandedsword.png');
const wp3 = new weaponsFactory('Scimitar', 1, 4, 100, 'sword_03', 'img/itens/weapons/scimitar.png');
const wp4 = new weaponsFactory('Lionheart', 1, 5, 100, 'sword_04', 'img/itens/weapons/lionheart.png');
const wp5 = new weaponsFactory('Sparta', 1, 6, 100, 'sword_05', 'img/itens/weapons/sparta.png');
...
const dh2 = new defensesFactory('White Bandana', 2, 1, 1, 'helmet_02', 'img/itens/defenses/whitebandana.png');
const dh11 = new defensesFactory('Red Baseball Cap', 2, 1, 1, 'helmet_03', 'img/itens/defenses/redebaseballcap.png');
const dh9 = new defensesFactory('Brown Skull Cap', 2, 1, 1, 'helmet_04', 'img/itens/defenses/brownskullcap.png');
const dh17 = new defensesFactory('Brown Bamboo Hat', 2, 1, 1, 'helmet_17', 'img/itens/defenses/brownbamboohat.png');
const dh3 = new defensesFactory('Metal Gear', 2, 1, 1, 'helmet_05', 'img/itens/defenses/metalgear.png');
const dh16 = new defensesFactory('Red Duke', 2, 1, 1, 'helmet_16', 'img/itens/defenses/redduke.png');
const dh4 = new defensesFactory('Metal Coif', 2, 1, 1, 'helmet_06', 'img/itens/defenses/metalcoif.png');
const dh5 = new defensesFactory('Steel Helmet', 2, 1, 1, 'helmet_07', 'img/itens/defenses/steelhelmet.png');
const dh19 = new defensesFactory('Silver Crusader Helm', 2, 1, 1, 'helmet_19', 'img/itens/defenses/silvercrusadehelm.png');
const dh13 = new defensesFactory('Old Steel Nordic Helm', 2, 1, 1, 'helmet_13', 'img/itens/defenses/oldsteelnordichelm.png');
const dh18 = new defensesFactory('Steel Sharp Helm', 2, 1, 1, 'helmet_18', 'img/itens/defenses/steelsharphelm.png');
const dh12 = new defensesFactory('Steel Nordic Helm', 2, 1, 1, 'helmet_12', 'img/itens/defenses/steelnordichelm.png');
const dh6 = new defensesFactory('Great Brown Helmet', 2, 1, 1, 'helmet_08', 'img/itens/defenses/greatbrownhelmet.png');
const dh10 = new defensesFactory('Iron Viking Helm', 2, 1, 1, 'helmet_11', 'img/itens/defenses/ironvikinghelm.png');
const dh8 = new defensesFactory('Steel Full Helm', 2, 1, 1, 'helmet_10', 'img/itens/defenses/steelfullhelm.png');
const dh21 = new defensesFactory('Silver Planet', 2, 1, 1, 'helmet_21', 'img/itens/defenses/silverplanet.png');
const dh20 = new defensesFactory('Red Oriental Helm', 2, 1, 1, 'helmet_20', 'img/itens/defenses/redorientalhelm.png');
const dh23 = new defensesFactory('Dark Falcon', 2, 1, 1, 'helmet_23', 'img/itens/defenses/darkfalcon.png');
const dh24 = new defensesFactory('Zakum Helmet', 2, 1, 1, 'helmet_24', 'img/itens/defenses/zakumhelmet.png');
const dh14 = new defensesFactory('Jousting Helmet', 2, 1, 1, 'helmet_14', 'img/itens/defenses/joustinghelmet.png');
const dh7 = new defensesFactory('Iron Burgernet Helm', 2, 1, 1, 'helmet_09', 'img/itens/defenses/ironburgernethelm.png');
const dh15 = new defensesFactory('Emerald Dome', 2, 1, 1, 'helmet_15', 'img/itens/defenses/emeralddome.png');
const dh25 = new defensesFactory('Dark Valhalla Helmet', 2, 1, 1, 'helmet_25', 'img/itens/defenses/darkvalhallahelmet.png');
const dh26 = new defensesFactory('Dark Lich Helmet', 2, 1, 1, 'helmet_26', 'img/itens/defenses/darkarlichelmet.png');
const dh27 = new defensesFactory('Drake Hat', 2, 1, 1, 'helmet_27', 'img/itens/defenses/drakehat.png');
const dh28 = new defensesFactory('Maple Hat', 2, 1, 1, 'helmet_28', 'img/itens/defenses/maplehat.png');
const dh29 = new defensesFactory('Dark Grace Helmet', 2, 1, 1, 'helmet_29', 'img/itens/defenses/darkgracehelmet.png');
const dh30 = new defensesFactory('Blue Dragon Helmet', 2, 1, 1, 'helmet_30', 'img/itens/defenses/bluedragonhelmet.png');
const dh31 = new defensesFactory('Herculean Helmet', 2, 1, 1, 'helmet_31', 'img/itens/defenses/herculeanhelmet.png');
const dh32 = new defensesFactory('Bosshunter Helm', 2, 1, 1, 'helmet_32', 'img/itens/defenses/bosshunterhelm.png');
const dh33 = new defensesFactory('Bosshunter Faceguard', 2, 1, 1, 'helmet_33', 'img/itens/defenses/bosshunterfaceguard.png');
const dh34 = new defensesFactory("Warrior's Helmet", 2, 1, 1, 'helmet_34', 'img/itens/defenses/warriorshelmet.png');
const dh35 = new defensesFactory('Blitz Helm', 2, 1, 1, 'helmet_35', 'img/itens/defenses/blitzhelm.png');
const dh36 = new defensesFactory('Aran Helmet', 2, 1, 1, 'helmet_36', 'img/itens/defenses/aranhelmet.png');
const dh37 = new defensesFactory('Powerfull Visitor Helm', 2, 1, 1, 'helmet_37', 'img/itens/defenses/powerfullvisitorhelm.png');
const dh38 = new defensesFactory('Wise Visitor Helm', 2, 1, 1, 'helmet_38', 'img/itens/defenses/wisevisitorhelmet.png');
const dh39 = new defensesFactory('Dexterious Visitor Helm', 2, 1, 1, 'helmet_39', 'img/itens/defenses/dexterousvisitorhelmet.png');
const dh40 = new defensesFactory('Lucky Visitor Helm', 2, 1, 1, 'helmet_40', 'img/itens/defenses/luckyvisitorhelmet.png');
const dh41 = new defensesFactory('Max Von Leon Helmet', 2, 1, 1, 'helmet_41', 'img/itens/defenses/marxvonleonhelmet.png');
const dh42 = new defensesFactory("Amaterasu's Helm", 2, 1, 1, 'helmet_42', 'img/itens/defenses/amaterasushelm.png');
const dh43 = new defensesFactory('Oyamatsumis Helm', 2, 1, 1, 'helmet_43', 'img/itens/defenses/oyamatsumishelm.png');
const dh44 = new defensesFactory("High Knight's Helm", 2, 1, 1, 'helmet_44', 'img/itens/defenses/highknightshelm.png');
const dh45 = new defensesFactory("Yukimura's Helm", 2, 1, 1, 'helmet_45', 'img/itens/defenses/yukimurashelm.png');
const dh46 = new defensesFactory("Kanetsuku's Helm", 2, 1, 1, 'helmet_46', 'img/itens/defenses/kanetsukushelm.png');
const dh47 = new defensesFactory("Hideyoshi's Helm", 2, 1, 1, 'helmet_47', 'img/itens/defenses/hideyoshishelm.png');
const dh48 = new defensesFactory('Legendary Ravana Helmet', 2, 1, 1, 'helmet_48', 'img/itens/defenses/legendaryravanahelmet.png');
const dh49 = new defensesFactory('Muneshiges Helm', 2, 1, 1, 'helmet_49', 'img/itens/defenses/muneshigeshelm.png');
const dh50 = new defensesFactory("The Bladed Falcon's helm", 2, 1, 1, 'helmet_50', 'img/itens/defenses/thebladedfalconshelm.png');
const dh51 = new defensesFactory('Viking Helmet', 2, 1, 1, 'helmet_51', 'img/itens/defenses/vikinghelmet.png');
const dh52 = new defensesFactory('Shadow Thanatos Helm', 2, 1, 1, 'helmet_52', 'img/itens/defenses/shadowthanatoshelm.png');
const dh53 = new defensesFactory('Necromancer Warrior Hat', 2, 1, 1, 'helmet_53', 'img/itens/defenses/necromancerwarriorhat.png');
const dh54 = new defensesFactory('Couples Army Helm', 2, 1, 1, 'helmet_54', 'img/itens/defenses/couplesarmyhelm.png');
const dh55 = new defensesFactory("Dragon Emperor's Helm", 2, 1, 1, 'helmet_55', 'img/itens/defenses/dragonemperorshelm.png');
const dh56 = new defensesFactory('Arcane Umbra Knight Hat', 2, 1, 1, 'helmet_56', 'img/itens/defenses/arcaneumbraknighthat.png');
const da1 = new defensesFactory('Yellow Jangoon Armor', 2, 1, 1, 'armor_01', 'img/itens/defenses/yellowjangoonarmor.png');
const da2 = new defensesFactory('Brown Hard Leather Top', 2, 1, 1, 'armor_02', 'img/itens/defenses/brownhardleathertop.png');
...
const hp2 = new potionsFactory('Adventurer HP', 25, 40, 10, 'HP_02', 'img/itens/potions/hp2.png');
const mp2 = new potionsFactory('Adventurer MP', 25, 40, 10, 'MP_02', 'img/itens/potions/mp2.png');
