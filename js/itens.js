...
const da5 = new defensesFactory('Red Hwarang Shirt', 1, 1, 100, 'armor_05', 'img/itens/defenses/redhwarangshirt.png');
const da2 = new defensesFactory('Brown Hard Leather Top', 5, 1, 1, 'armor_02', 'img/itens/defenses/brownhardleathertop.png');
...
const dp2 = new defensesFactory('Black Suit Pants', 1, 1, 100, 'pants_02', 'img/itens/defenses/blacksuitpants.png');
const dp3 = new defensesFactory('Grey Thick Sweat Pants', 5, 1, 1, 'pants_03', 'img/itens/defenses/greythicksweatpants.png');
...
const db2 = new defensesFactory('Royal Costume Shoes', 5, 1, 1, 'boots_02', 'img/itens/defenses/royalcostumeshoes.png');
...
const hp2 = new potionsFactory('Adventurer HP', 5, 40, 6, 'HP_02', 'img/itens/potions/hp2.png');
const mp2 = new potionsFactory('Adventurer MP', 5, 40, 15, 'MP_02', 'img/itens/potions/mp2.png');
